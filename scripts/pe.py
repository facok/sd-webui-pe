...
expansionPath = os.path.abspath(os.path.join(os.path.dirname(__file__), 'expansion'))
...
class PromptsExpansion:
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained(expansionPath)

        positive_words = open(os.path.join(expansionPath, 'positive.txt'),
        ...
        self.model = AutoModelForCausalLM.from_pretrained(expansionPath)
        self.model.eval()
        ...
        print(f'Prompt Expansion engine loaded for {load_device}, use_fp16 = {use_fp16}.')
